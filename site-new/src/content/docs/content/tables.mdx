...
{/* TODO: fix this use case which doesn't work anymore even in the tables.mdx example with <Code/> */}
```html
<!-- On tables -->
...
{/* TODO: original code tests if not (eq . "xs") but the value never can't be that */}
    ...
    <div class="bd-example">
      <div class={`table-responsive${breakpoint.abbr}`}>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">#{breakpoint.breakpoint}</th>
              <th scope="col">Heading</th>
              <th scope="col">Heading</th>
              <th scope="col">Heading</th>
              <th scope="col">Heading</th>
