...
toc: true
extra_js:
  - src: "/docs/[[param:docs_version]]/assets/js/validate-forms.js"
    async: true
---
...
<Code containerClass="bd-example-snippet" lang="js" filePath="site-new/static/docs/[version]/assets/js/validate-forms.js" />
