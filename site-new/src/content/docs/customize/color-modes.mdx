...
toc: true
added: "5.3"
# TODO: <hr> changed to <hr/> and shouldn't be
# TODO: "example" shortcode
---
...
<Example class="p-0" code={`<div data-bs-theme="dark" class="p-3 text-body bg-body">
...
{/* TODO(HiDeoo) Rename path */}
<Code containerClass="bd-example-snippet" lang="js" filePath="site-new/static/docs/[version]/assets/js/color-modes.js" />
